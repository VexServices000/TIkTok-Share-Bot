    ...
    try:
        ...
        try:
            if (req.json()["status_code"] == 0):
                ...
                TotalSentShare += 1
                if DebugMode == True:
                    print(Colorate.Horizontal(Colors.red_to_purple, f"Sent Share: {TotalSentShare}"))
                else:
                    print(Colorate.Horizontal(Colors.red_to_purple, f"Sent Share: {TotalSentShare}"))
...
print(Colorate.Vertical(Colors.yellow_to_red,(Center.XCenter('''                                                                                                                            
                               ...
                               ....,fGGCGGCft1tLGG00GGt,...                                         
                                ....,1CGGGGGGGGGGG0GC1.....                                         
                                  ....:tCGGGGGGGGCL1:.....
                                    ....,:;11111;,. .....
                             StanTheMan#5959 on Discord | VEX SERVICES
                                       
''')), 1))


if (__name__ == "__main__"):
    itemID       = Write.Input("Video Link > ", Colors.yellow_to_red, interval=0.0001)
    amount       = Write.Input("Amount (0=inf) > ", Colors.yellow_to_red, interval=0.0001)
    NThread      = Write.Input("Thread Amount > ", Colors.yellow_to_red, interval=0.0001)
